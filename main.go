...
func runBuild() {
	...
	whitedomainsHeader := []string{
		"# whitedomains -> Shadowrocket rule-set (geosite:direct equivalent)",
		"# source: farestz/whitelists curated RU whitelist (same data as whitedomains.dat)",
		"# generated by farestz/whitelists — do not edit by hand",
	}
	if err := writeDomainRuleSet(domainListFile, whitedomainsHeader, domains); err != nil {
...
func writeGeositeList(dat, tag, outFile string) error {
	...
	header := []string{
		fmt.Sprintf("# geosite:%s -> Shadowrocket rule-set", tag),
		fmt.Sprintf("# source: Loyalsoldier/v2ray-rules-dat geosite.dat (tag %s)", strings.ToUpper(tag)),
		"# generated by farestz/whitelists — do not edit by hand",
	}
	return writeDomainRuleSet(outFile, header, entries)
}
...
func writeDomainRuleSet(outFile string, header []string, entries []domainEntry) error {
